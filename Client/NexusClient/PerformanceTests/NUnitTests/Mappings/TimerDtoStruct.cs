...
namespace NexusClient.PerformanceTests.NUnitTests.Mappings
{
	public struct TimerDtoStruct
	{
		...
		/// <summary>
		///     The benefit of this method is that you may implement <see cref="From(NexusClient.PerformanceTests.NUnitTests.Objects.Timer)" />
		///     and <see cref="To(NexusClient.PerformanceTests.NUnitTests.Objects.Timer)" /> directly within your
